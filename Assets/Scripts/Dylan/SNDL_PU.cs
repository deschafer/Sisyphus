...
{
    /* The class SNDL_PU is a subclass of the PU_HUD_HANDLER class.  Inheriting all of the set variables and defined functions of the superclass.
     */
   ...
   */
    ...
    /* At start the sandal object is set to the TimeOut object that is current generated by using the Unityengine function FindObjectOfType<>.  This sets the
     * variable sandal to the instance of the TimeOut class that is controlling the powerup on the screen.
     * The color of the winged sandal power up sprite is also set to default color and full transparency.
     */
    ...
    public override void Update()
    {
        if (sandal.type == 1)
        {
            /* If the type of powerup on the screen is the winged sandal then the rest of the function is enacted.  This type value is checked once per frame of the 
           ...
           */
            ...
            {
                /* If the type of the power up is sandal and the timer active is greater than 0 then the sandal sprite becomes opaque.
            ...
            else if (sandal.timerActive <=  0.0f)
            {
                ...
                timer.color = new Color(0f, 0f, 0f, Mathf.Lerp(timer.color.a, minAlpha, step));
